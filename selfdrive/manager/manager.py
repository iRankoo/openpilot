...
#    params.clear_all(ParamKeyType.DEVELOPMENT_ONLY)
  ...
  # set version params
  params.put("Version",  Params().get("Version", encoding='utf-8'))
  params.put("TermsVersion", terms_version)
  params.put("TrainingVersion", training_version)
  params.put("GitCommit",  Params().get("GitCommit", encoding='utf-8'))
  params.put("GitCommitDate",  Params().get("GitCommitDate", encoding='utf-8'))
  params.put("GitBranch",  Params().get("GitBranch", encoding='utf-8'))
  params.put("GitRemote",  Params().get("GitRemote", encoding='utf-8'))
